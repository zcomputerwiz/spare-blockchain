...
rm -rf ../venv || true
rm -rf venv || true
rm -rf spare_blockchain.egg-info || true
rm -rf build_scripts/final_installer || true
rm -rf build_scripts/dist || true
rm -rf build_scripts/pyinstaller || true
rm -rf spare-blockchain-gui/build || true
rm -rf spare-blockchain-gui/daemon || true
rm -rf spare-blockchain-gui/node_modules || true
rm spare-blockchain-gui/temp.json || true
( cd "$PWD/spare-blockchain-gui" && git checkout HEAD -- package-lock.json ) || true
cd "$PWD" || true
...
npm uninstall -g @spare-network/notarize-cli || true
